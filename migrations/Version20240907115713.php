...
final class Version20240907115713 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE event (id INT AUTO_INCREMENT NOT NULL, event_section_id INT NOT NULL, event_frequence_id INT NOT NULL, created_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', updated_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', side VARCHAR(255) NOT NULL, visible TINYINT(1) NOT NULL, status VARCHAR(255) NOT NULL, text VARCHAR(255) NOT NULL, author VARCHAR(255) NOT NULL, type VARCHAR(255) NOT NULL, periode_start DATE NOT NULL, periode_end DATE DEFAULT NULL, periode_unlimited TINYINT(1) DEFAULT NULL, INDEX IDX_3BAE0AA780CD3A55 (event_section_id), UNIQUE INDEX UNIQ_3BAE0AA7635B72F6 (event_frequence_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE event_frequence (id INT AUTO_INCREMENT NOT NULL, created_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', updated_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', everyday TINYINT(1) DEFAULT NULL, week_days JSON DEFAULT NULL, month_day INT DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
