 ...
 */
final class Version20241025151300 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE event (id INT AUTO_INCREMENT NOT NULL, section_id INT NOT NULL, event_recurring_id VARCHAR(255) DEFAULT NULL, created_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', updated_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', due_date DATE NOT NULL COMMENT \'(DC2Type:date_immutable)\', is_recurring TINYINT(1) NOT NULL, date DATE NOT NULL COMMENT \'(DC2Type:date_immutable)\', type VARCHAR(255) NOT NULL, is_important TINYINT(1) NOT NULL, title LONGTEXT NOT NULL, description LONGTEXT NOT NULL, created_by VARCHAR(255) NOT NULL, updated_by VARCHAR(255) DEFAULT NULL, date_status VARCHAR(50) NOT NULL, active_day INT DEFAULT NULL, side VARCHAR(255) NOT NULL, date_limit DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', user_read_info_count INT NOT NULL, INDEX IDX_3BAE0AA7D823E37A (section_id), INDEX IDX_3BAE0AA75C5AC3AD (event_recurring_id), INDEX event_date_status_active_day_idx (date_status, active_day), INDEX event_date_status_due_date_idx (date_status, due_date), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE event_recurring (id VARCHAR(255) NOT NULL, created_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', updated_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', periodeStart DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', periodeEnd DATETIME DEFAULT NULL COMMENT \'(DC2Type:datetime_immutable)\', is_everyday TINYINT(1) NOT NULL, INDEX eventRecurring_period_idx (periodeStart, periodeEnd), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
