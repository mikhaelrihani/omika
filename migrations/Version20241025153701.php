 ...
 */
final class Version20241025153701 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE event (id INT AUTO_INCREMENT NOT NULL, section_id INT NOT NULL, event_recurring_id INT DEFAULT NULL, created_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', updated_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', due_date DATE NOT NULL COMMENT \'(DC2Type:date_immutable)\', is_recurring TINYINT(1) NOT NULL, date DATE NOT NULL COMMENT \'(DC2Type:date_immutable)\', type VARCHAR(255) NOT NULL, is_important TINYINT(1) NOT NULL, title LONGTEXT NOT NULL, description LONGTEXT NOT NULL, created_by VARCHAR(255) NOT NULL, updated_by VARCHAR(255) DEFAULT NULL, date_status VARCHAR(50) NOT NULL, active_day INT DEFAULT NULL, side VARCHAR(255) NOT NULL, date_limit DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', user_read_info_count INT NOT NULL, INDEX IDX_3BAE0AA7D823E37A (section_id), INDEX IDX_3BAE0AA75C5AC3AD (event_recurring_id), INDEX event_date_status_active_day_idx (date_status, active_day), INDEX event_date_status_due_date_idx (date_status, due_date), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE event_user_share (event_id INT NOT NULL, user_id INT NOT NULL, INDEX IDX_552ABF2D71F7E88B (event_id), INDEX IDX_552ABF2DA76ED395 (user_id), PRIMARY KEY(event_id, user_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE event_task (id INT AUTO_INCREMENT NOT NULL, created_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', updated_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', task_details VARCHAR(100) DEFAULT NULL, task_status VARCHAR(50) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE issue (id INT AUTO_INCREMENT NOT NULL, technician_contacted_id INT NOT NULL, technician_coming_id INT DEFAULT NULL, created_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', updated_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', count_number INT NOT NULL, status VARCHAR(255) NOT NULL, author VARCHAR(255) NOT NULL, summary VARCHAR(50) NOT NULL, description VARCHAR(1000) NOT NULL, fix_date DATE DEFAULT NULL, fix_time TIME DEFAULT NULL, follow_up INT DEFAULT NULL, solution VARCHAR(1000) DEFAULT NULL, INDEX IDX_12AD233ED5AFAE6D (technician_contacted_id), INDEX IDX_12AD233E5E1744C5 (technician_coming_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE tag (id INT AUTO_INCREMENT NOT NULL, created_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', updated_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', section VARCHAR(255) NOT NULL, day DATE NOT NULL, date_status VARCHAR(255) NOT NULL, task_count INT NOT NULL, active_day INT DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE user_login (id INT AUTO_INCREMENT NOT NULL, created_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', updated_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', email VARCHAR(180) NOT NULL, roles JSON NOT NULL, password VARCHAR(255) NOT NULL, is_enabled TINYINT(1) NOT NULL, UNIQUE INDEX UNIQ_IDENTIFIER_EMAIL (email), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE event_user_share ADD CONSTRAINT FK_552ABF2D71F7E88B FOREIGN KEY (event_id) REFERENCES event (id) ON DELETE CASCADE');
        $this->addSql('ALTER TABLE event_user_share ADD CONSTRAINT FK_552ABF2DA76ED395 FOREIGN KEY (user_id) REFERENCES user (id) ON DELETE CASCADE');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE event_user_share DROP FOREIGN KEY FK_552ABF2DA76ED395');
        ...
        $this->addSql('DROP TABLE event_user_share');
